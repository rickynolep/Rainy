...
export declare namespace Beatmapset {
    ...
    namespace Event {
        ...
        export function getMultiple(this: API, from?: {
            ...
            min_date?: Date;
            max_date?: Date;
        }, types?: Event["type"][], config?: Miscellaneous.Config): Promise<{
            events: Event.Any[];
    ...
    namespace Discussion {
        ...
        namespace Post {
            ...
            function getMultiple(this: API, from?: {
                ...
                user?: User["id"] | User;
            }, types?: ("first" | "reply" | "system")[], config?: Miscellaneous.Config): Promise<{
        ...
        namespace Vote {
            ...
            }, score?: 1 | -1, config?: Miscellaneous.Config): Promise<{
                votes: Vote[];
        ...
        }, config?: Miscellaneous.Config): Promise<{
            beatmaps: Beatmap.Extended[];
