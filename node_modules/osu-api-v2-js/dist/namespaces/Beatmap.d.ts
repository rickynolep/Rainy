...
export declare namespace Beatmap {
    ...
    namespace Pack {
         ...
         */
        function getMultiple(this: API, type?: "standard" | "featured" | "tournament" | "loved" | "chart" | "theme" | "artist", cursor_string?: Miscellaneous.CursorString): Promise<{
            beatmap_packs: Pack[];
     ...
     */
    function getUserScore(this: API, beatmap: Beatmap["id"] | Beatmap, user: User["id"] | User, config?: Pick<Config, "ruleset" | "mods" | "legacy_only">): Promise<{
     ...
     */
    function getUserScores(this: API, beatmap: Beatmap["id"] | Beatmap, user: User["id"] | User, config?: Pick<Config, "ruleset" | "legacy_only">): Promise<Score[]>;
    /**
