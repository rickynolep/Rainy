...
export declare namespace Miscellaneous {
    ...
    namespace Country {
        ...
        */
        function getRanking(this: API, ruleset: Ruleset, page?: Page): Promise<Country.Ranking>;
    }
    /**
     ...
     */
    function getSeasonalBackgrounds(this: API): Promise<{
        ends_at: Date;
        backgrounds: {
            url: string;
            user: User;
