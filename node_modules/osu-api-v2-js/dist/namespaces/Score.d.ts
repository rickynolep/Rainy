...
export declare namespace Score {
     ...
     */
    type Grade = "XH" | "X" | "SH" | "S" | "A" | "B" | "C" | "D" | "F";
    ...
    interface WithMatchPerfect extends Omit<Score, "id" | "type" | "classic_total_score" | "preserve" | "ranked"> {
     ...
     */
    function getSome(this: API, config?: Pick<Miscellaneous.Config, "cursor_string"> & {
