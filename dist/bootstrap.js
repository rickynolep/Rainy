...
globalThis.dim = (text) => `\x1b[2m${text}\x1b[0m`;
globalThis.red = (text) => `\x1b[31m${text}\x1b[0m`;
globalThis.green = (text) => `\x1b[32m${text}\x1b[0m`;
globalThis.yellow = (text) => `\x1b[33m${text}\x1b[0m`;
console.log(dim(`[I] Detected runtime: ${runtime}`));
export function getFileMeta(importMeta) {
